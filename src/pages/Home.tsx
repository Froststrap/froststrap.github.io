  ...
  return (
    <>
      <div className="min-h-screen bg-background text-foreground -z-10">
        ...
        {/* Main Content */}
        <main className="container py-16 z-10">
          {/* Hero Section */}
          <div className="flex flex-col items-center text-center space-y-6 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl z-10">
          ...
          {/* Features Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-centerz-10">
            <div className="p-6 bg-card border border-border rounded-lg hover:border-primary transition-colors z-10">
